...
namespace Evincemage\Newsletter\Controller\Subscriber; 
...
class NewAction extends SubscriberController implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        if ($this->getRequest()->isPost() && $this->getRequest()->getPost('email')) {
            ...
            $subscriber_name = (string)$this->getRequest()->getParam('subscriber_name');
            ...
            try {
                ...
                $subscriber = $currentCustomerId
                    ...
                    $subscriber->setSubscriberName($subscriber_name)->save();
    ...
    private function getSuccessMessage(int $status): Phrase
    {
        ...
        return __($subscriber_name.'Thank You for Subscription');
    }
